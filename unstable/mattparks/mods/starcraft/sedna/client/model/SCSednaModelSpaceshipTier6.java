package mattparks.mods.starcraft.sedna.client.model;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class SCSednaModelSpaceshipTier6 extends ModelBase
{
    // Roof, Floor, Bottom
    ...
    public SCSednaModelSpaceshipTier6()
    {
        this(0.0F);
    }

    public SCSednaModelSpaceshipTier6(float var1)
    {
