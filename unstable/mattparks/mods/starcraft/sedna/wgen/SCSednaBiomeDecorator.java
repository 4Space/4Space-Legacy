...
public class SCSednaBiomeDecorator
{
...
//    protected WorldGenerator copperGen;
    ...
    public SCSednaBiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        this.palladiumGen = new GCCoreWorldGenMinableMeta(SednaBlocks.PalladiumOre.blockID, 4, 0, true, SednaBlocks.PalladiumOre.blockID, 4);
        this.dirtGen = new GCCoreWorldGenMinableMeta(SednaBlocks.SednaDirt.blockID, 32, 1, false, SednaBlocks.SednaStone.blockID, 4); 
