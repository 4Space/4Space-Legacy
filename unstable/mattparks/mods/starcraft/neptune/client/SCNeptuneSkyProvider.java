...
public class SCNeptuneSkyProvider extends IRenderHandler
{
	private static final ResourceLocation sunTexture = new ResourceLocation(NeptuneCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCNeptuneSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCNeptuneWorldProvider gcProvider = null;

        if (world.provider instanceof SCNeptuneWorldProvider)
        {
            gcProvider = (SCNeptuneWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCNeptuneSkyProvider.sunTexture);
