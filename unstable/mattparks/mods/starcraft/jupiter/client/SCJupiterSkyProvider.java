...
public class SCJupiterSkyProvider extends IRenderHandler
{
    private static final ResourceLocation saturnTexture = new ResourceLocation(JupiterCore.ASSET_DOMAIN, "textures/gui/planets/saturn.png");
    private static final ResourceLocation sunTexture = new ResourceLocation(JupiterCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCJupiterSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCJupiterWorldProvider gcProvider = null;

        if (world.provider instanceof SCJupiterWorldProvider)
        {
            gcProvider = (SCJupiterWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCJupiterSkyProvider.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCJupiterSkyProvider.saturnTexture);
        var23.startDrawingQuads();
