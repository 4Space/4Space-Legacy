...
public class SCSednaItemGravityBoots extends ItemArmor
{
    public boolean attachedMask;
    private final EnumArmorMaterial material;

    public SCSednaItemGravityBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, boolean breathable)
    {
    ...
    {
        if (this.material == SednaItems.ARMORGRAVITY)
        {
            if (stack.getItem().itemID == SednaItems.gravityBoots.itemID)
            {
