...
public class SednaBlocks 
{
	...
	// Block Sedna Grass
	public static final Block SednaGrass = new SCSednaGrass(731, null)
	...
	// Block Sedna Dirt
	public static final Block SednaDirt = new SCBlock(732, null)
	...
	// Block Sedna Stone
	public static final Block SednaStone = new SCSednaStone(733, null)
	...
	public static final Block SednaCobblestone = new SCBlock(734, null)
			.setHardness(1.5F).setStepSound(Block.soundStoneFootstep)
	...
	// Block Sedna Brick
	public static final Block SednaBrick = new SCBlock(735, null)
	...
	public static final Block PalladiumOre = new SCSednaOre(726, null)
			.setHardness(1.5F).setStepSound(Block.soundStoneFootstep)
	...
	public static final Block PalladiumBlock = new SCBlock(727, null)
			.setHardness(1.5F).setStepSound(Block.soundStoneFootstep)
