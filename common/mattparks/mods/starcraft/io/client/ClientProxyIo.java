...
public class ClientProxyIo extends CommonProxyIo
{
            ...
            if (type.equals(EnumSet.of(TickType.CLIENT)))
            {
                if (world != null)
                {
                    if (world.provider instanceof SCIoWorldProvider)
                    {
                        ...
                        {
                            world.provider.setSkyRenderer(new SCIoSkyProvider());
                        }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), IoCore.CHANNEL, Side.CLIENT);
    }
