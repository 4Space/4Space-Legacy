...
import mattparks.mods.starcraft.europa.client.SCEuropaSkyProvider;
...
public class SCIoSkyProvider extends IRenderHandler
{
	private static final ResourceLocation jupiterTexture = new ResourceLocation(IoCore.ASSET_DOMAIN, "textures/gui/planets/jupiter.png");
	...
	{
		SCIoWorldProvider gcProvider = null;

		if (world.provider instanceof SCIoWorldProvider)
		{
			gcProvider = (SCIoWorldProvider) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCIoSkyProvider.sunTexture);
