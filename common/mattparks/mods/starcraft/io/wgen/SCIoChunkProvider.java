...
import mattparks.mods.starcraft.io.blocks.IoBlocks;
...
public class SCIoChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) IoBlocks.IoHalfBasalt.blockID;
    final byte topBlockMeta = 2;
    final short fillBlockID = (short) IoBlocks.IoBasalt.blockID;
    final byte fillBlockMeta = 0;
    final short lowerBlockID = (short) IoBlocks.IoStone.blockID;
    ...
    public SCIoBiomeDecorator biomedecoratorplanet = new SCIoBiomeDecorator(SCIoBiomeGenBase.ioFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { SCIoBiomeGenBase.ioFlat };
    ...
    public SCIoChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCIoChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCIoChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCIoChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCIoChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return SCIoConfigManager.generateOtherMods ? "RandomLevelSource" : "IoLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCIoConfigManager.generateOtherMods)
         {
