package mattparks.mods.starcraft.callisto.dimension;

import mattparks.mods.starcraft.callisto.SCCallistoConfigManager;
import mattparks.mods.starcraft.callisto.wgen.SCCallistoChunkProvider;
import mattparks.mods.starcraft.callisto.wgen.SCCallistoWorldChunkManager;
...
public class SCCallistoWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    ...
    {
        return new SCCallistoChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCCallistoConfigManager.dimensionIDCallisto;
    }
    ...
    {
        this.worldChunkMgr = new SCCallistoWorldChunkManager();
    }
