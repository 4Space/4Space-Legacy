...
public class ClientProxyCallisto extends CommonProxyCallisto
{
            ...
            if (type.equals(EnumSet.of(TickType.CLIENT)))
            {
                if (world != null)
                {
                    if (world.provider instanceof SCCallistoWorldProvider)
                    {
                        ...
                        {
                            world.provider.setSkyRenderer(new SCCallistoSkyProvider());
                        }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), CallistoCore.CHANNEL, Side.CLIENT);
    }
