...
import mattparks.mods.starcraft.callisto.blocks.CallistoBlocks;
...
public class SCCallistoChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) CallistoBlocks.CallistoSurfaceStone.blockID;
    final byte topBlockMeta = 2;
    final short fillBlockID = (short) CallistoBlocks.CallistoSubStone.blockID;
    final byte fillBlockMeta = 0;
    final short lowerBlockID = (short) CallistoBlocks.CallistoStone.blockID;
    ...
    public SCCallistoBiomeDecorator biomedecoratorplanet = new SCCallistoBiomeDecorator(SCCallistoBiomeGenBase.callistoFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { SCCallistoBiomeGenBase.callistoFlat };
    ...
    public SCCallistoChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCCallistoChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCCallistoChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCCallistoChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCCallistoChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return SCCallistoConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCCallistoConfigManager.generateOtherMods)
         {
