package mattparks.mods.starcraft.callisto.network;
...
public class SCCallistoPacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Starcraft Callisto: Received bad packet!");
        }
