...
public class SCVenusComponentBlazePitStairway extends GCCoreStructureComponent
{
    private int[] orig = new int[3];
    private final SCVenusComponentBlazePitRoom originalRoom;
    
	protected SCVenusComponentBlazePitStairway(SCVenusComponentBlazePitRoom origRoom, int type, Random rand, int x, int y, int z) 
	{
		super(type);
