...
public class SCVenusRoomChests extends GCCoreDungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public SCVenusRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new SCVenusRoomChests(dungeon, x, y, z, dir);
	}
