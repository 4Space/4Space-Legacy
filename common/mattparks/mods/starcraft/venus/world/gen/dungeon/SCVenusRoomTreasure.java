...
public class SCVenusRoomTreasure extends GCCoreDungeonRoom
{
    ...
    public SCVenusRoomTreasure(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    public ItemStack getGuaranteedLoot(Random rand)
    {
        ...
        case 2:
            return new ItemStack(VenusItems.T3Schematic, 1, 0);
        }
    ...
    {
        return new SCVenusRoomTreasure(dungeon, x, y, z, dir);
    }
}
