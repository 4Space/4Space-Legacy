...
public class SCVenusSkyProvider extends IRenderHandler
{
    ...
    private static final ResourceLocation sunTexture = new ResourceLocation(VenusCore.ASSET_DOMAIN, "textures/environment/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCVenusSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCVenusWorldProvider gcProvider = null;

        if (world.provider instanceof SCVenusWorldProvider)
        {
            gcProvider = (SCVenusWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCVenusSkyProvider.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCVenusSkyProvider.overworldTexture);
        var23.startDrawingQuads();
