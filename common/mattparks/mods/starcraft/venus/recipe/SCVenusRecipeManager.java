...
public class SCVenusRecipeManager
{
    private static void addUniversalRecipes()
    {
    	...
    	OreDictionary.registerOre("VenusCrystal", new ItemStack(VenusItems.venusItemBasic, 1, 8));
    	OreDictionary.registerOre("FossilizedPlant", new ItemStack(VenusItems.venusItemBasic, 1, 10));
        ...
        RecipeUtil.addRecipe(new ItemStack(VenusItems.venusItemBasic, 9, 9), new Object[] { "X", 'X', VenusBlocks.CrystalBlock });
        ...
        FurnaceRecipes.smelting().addSmelting(VenusBlocks.VenusCrystalOre.blockID, 0, new ItemStack(VenusItems.venusItemBasic, 1, 9), 0.2F);
        ...
        FurnaceRecipes.smelting().addSmelting(VenusBlocks.FossilizedPlantOre.blockID, 0, new ItemStack(VenusItems.venusItemBasic, 1, 10), 0.2F);
