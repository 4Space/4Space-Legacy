...
import mattparks.mods.starcraft.europa.blocks.EuropaBlocks;
...
public class SCEuropaChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) EuropaBlocks.EuropaHardIce.blockID;
    final byte topBlockMeta = 2;
    final short fillBlockID = (short) EuropaBlocks.EuropaSoftIce.blockID;
    ...
    public SCEuropaBiomeDecorator biomedecoratorplanet = new SCEuropaBiomeDecorator(SCEuropaBiomeGenBase.europaFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { SCEuropaBiomeGenBase.europaFlat };
    ...
    public SCEuropaChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCEuropaChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCEuropaChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCEuropaChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCEuropaChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return SCEuropaConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCEuropaConfigManager.generateOtherMods)
         {
