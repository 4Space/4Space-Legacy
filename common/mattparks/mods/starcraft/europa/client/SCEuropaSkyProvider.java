...
{
	private static final ResourceLocation jupiterTexture = new ResourceLocation(EuropaCore.ASSET_DOMAIN, "textures/gui/planets/jupiter.png");
	...
	{
		SCEuropaWorldProvider gcProvider = null;

		if (world.provider instanceof SCEuropaWorldProvider)
		{
			gcProvider = (SCEuropaWorldProvider) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCEuropaSkyProvider.sunTexture);
		...
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 5F);
		GL11.glRotatef(world.getCelestialAngle(partialTicks) * 80.0F, 1.0F, 0.0F, 0.0F);
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCEuropaSkyProvider.jupiterTexture);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, 95.0D, -var12, 0.0D, 0.0D);
		var23.addVertexWithUV(var12, 95.0D, -var12, 1.0D, 0.0D);
		var23.addVertexWithUV(var12, 95.0D, var12, 1.0D, 1.0D);
		var23.addVertexWithUV(-var12, 95.0D, var12, 0.0D, 1.0D);
		var23.draw();
