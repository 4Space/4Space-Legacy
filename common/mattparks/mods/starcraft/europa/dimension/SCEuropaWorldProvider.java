...
public class SCEuropaWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCEuropaChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCEuropaConfigManager.dimensionIDEuropa;
    }
    ...
    {
        this.worldChunkMgr = new SCEuropaWorldChunkManager();
    }
