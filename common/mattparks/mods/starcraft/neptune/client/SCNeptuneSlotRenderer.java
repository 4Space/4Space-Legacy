...
public class SCNeptuneSlotRenderer implements ICelestialBodyRenderer
{
    ...
    {
        return new ResourceLocation(NeptuneCore.ASSET_DOMAIN, "textures/gui/planets/neptune.png");
    }
