package mattparks.mods.starcraft.moons.client;
...
import mattparks.mods.starcraft.moons.CommonProxyMoons;
...
import mattparks.mods.starcraft.moons.client.render.item.SCJupiterItemRendererSpaceshipT5;
...
public class ClientProxyMoons extends CommonProxyMoons
{
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
            return "Galacticraft Moons Client";
        }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), MoonsCore.CHANNEL, Side.CLIENT);
    }
