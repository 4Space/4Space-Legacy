package mattparks.mods.starcraft.moons.client.render.item;

import mattparks.mods.starcraft.moons.MoonsCore;
import mattparks.mods.starcraft.moons.client.model.SCJupiterModelSpaceshipTier5;
...
public class SCJupiterItemRendererSpaceshipT5 extends GCCoreItemRendererSpaceship
{
    ...
    public SCJupiterItemRendererSpaceshipT5(IModelCustom cargoRocketModel)
    {
        super(new SCJupiterEntityRocketT5(FMLClientHandler.instance().getClient().theWorld), new SCJupiterModelSpaceshipTier5(), new ResourceLocation(MoonsCore.ASSET_DOMAIN, "textures/model/rocketT5.png"));
