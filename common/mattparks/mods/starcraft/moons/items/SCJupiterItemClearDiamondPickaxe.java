...
public class SCJupiterItemClearDiamondPickaxe extends ItemPickaxe
{
    public SCJupiterItemClearDiamondPickaxe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
