...
public class SCMercuryEntityRocketT4 extends EntityTieredRocket
{
    ...
    public SCMercuryEntityRocketT4(World par1World)
    {
        super(par1World);
    }

    public SCMercuryEntityRocketT4(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
        this(par1World, par2, par4, par6, rocketType);
        this.cargoItems = inv;
    }

    public SCMercuryEntityRocketT4(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
