...
public class SCMercuryItemRendererSpaceshipT4 extends GCCoreItemRendererSpaceship
{
    ...
    public SCMercuryItemRendererSpaceshipT4(IModelCustom cargoRocketModel)
    {
        super(new SCMercuryEntityRocketT4(FMLClientHandler.instance().getClient().theWorld), new SCMercuryModelSpaceshipTier4(), new ResourceLocation(MercuryCore.ASSET_DOMAIN, "textures/model/rocketT4.png"));
