...
public class SCMercuryRoomChests extends GCCoreDungeonRoom
{
    ...
    public SCMercuryRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new SCMercuryRoomChests(dungeon, x, y, z, dir);
    }
}
