...
public class ClientProxyGanymede extends CommonProxyGanymede
{
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
            return "Starcraft Ganymede Client";
        }
            ...
            if (type.equals(EnumSet.of(TickType.CLIENT)))
            {
                if (world != null)
                {
                    if (world.provider instanceof SCGanymedeWorldProvider)
                    {
                        ...
                        {
                            world.provider.setSkyRenderer(new SCGanymedeSkyProvider());
                        }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), GanymedeCore.CHANNEL, Side.CLIENT);
    }
