...
import mattparks.mods.starcraft.ganymede.GanymedeCore;
...
public class SCGanymedeSkyProvider extends IRenderHandler
{
	private static final ResourceLocation jupiterTexture = new ResourceLocation(GanymedeCore.ASSET_DOMAIN, "textures/gui/planets/jupiter.png");
	...
	{
		SCGanymedeWorldProvider gcProvider = null;

		if (world.provider instanceof SCGanymedeWorldProvider)
		{
			gcProvider = (SCGanymedeWorldProvider) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCGanymedeSkyProvider.sunTexture);
		...
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 5F);
		GL11.glRotatef(world.getCelestialAngle(partialTicks) * 60.0F, 1.0F, 0.0F, 0.0F);
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCGanymedeSkyProvider.jupiterTexture);
		var23.startDrawingQuads();
