package mattparks.mods.starcraft.titan.dimension;

import mattparks.mods.starcraft.titan.SCTitanConfigManager;
import mattparks.mods.starcraft.titan.wgen.SCTitanChunkProvider;
import mattparks.mods.starcraft.titan.wgen.SCTitanWorldChunkManager;
...
public class SCTitanWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCTitanChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        this.worldChunkMgr = new SCTitanWorldChunkManager();
    }
