...
public class ClientProxyTitan extends CommonProxyTitan
{
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
            return "Starcraft Callisto Client";
        }
            ...
            if (type.equals(EnumSet.of(TickType.CLIENT)))
            {
                if (world != null)
                {
                    if (world.provider instanceof SCTitanWorldProvider)
                    {
                        ...
                        {
                            world.provider.setSkyRenderer(new SCTitanSkyProvider());
                        }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), TitanCore.CHANNEL, Side.CLIENT);
    }
