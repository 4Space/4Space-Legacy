...
public class SCTitanSkyProvider extends IRenderHandler
{
	private static final ResourceLocation saturnTexture = new ResourceLocation(TitanCore.ASSET_DOMAIN, "textures/gui/planets/saturn.png");
	...
	{
		SCTitanWorldProvider gcProvider = null;

		if (world.provider instanceof SCTitanWorldProvider)
		{
			gcProvider = (SCTitanWorldProvider) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCTitanSkyProvider.sunTexture);
