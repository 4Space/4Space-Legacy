package mattparks.mods.starcraft.titan.wgen;
...
import mattparks.mods.starcraft.titan.blocks.TitanBlocks;
...
public class SCTitanChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) TitanBlocks.TitanSurfaceStone.blockID;
    final byte topBlockMeta = 2;
    final short fillBlockID = (short) TitanBlocks.RockySolidWater.blockID;
    final byte fillBlockMeta = 0;
    final short lowerBlockID = (short) TitanBlocks.TitanStone.blockID;
    ...
    public SCTitanBiomeDecorator biomedecoratorplanet = new SCTitanBiomeDecorator(SCTitanBiomeGenBase.titanFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { SCTitanBiomeGenBase.titanFlat };
    ...
    public SCTitanChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCTitanChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCTitanChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCTitanChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCTitanChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return SCTitanConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCTitanConfigManager.generateOtherMods)
         {
