...
public class SCErisGenCaves extends GCCoreMapGenBaseMeta
{
                            ...
                            for (int localX = l1; localX < i2; localX++)
                            {
                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        ...
                                        {
                                            if (blockIdArray[coords] == ErisBlocks.ErisDirt.blockID)
                                            {
                                                if (metaArray[coords] == 3 || metaArray[coords] == 4)
                                                {
                                                    blockIdArray[coords] = 0;
                                                }
                                                else if (metaArray[coords] == 5 && random.nextInt(SCErisGenCaves.BREAK_THROUGH_CHANCE) == 0)
                                                {
                                                    blockIdArray[coords] = 0;
                                                }
                                            }
