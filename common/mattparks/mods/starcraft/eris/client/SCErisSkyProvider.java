...
public class SCErisSkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(ErisCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");
    ...
    {
        SCErisWorldProvider gcProvider = null;

        if (world.provider instanceof SCErisWorldProvider)
        {
            gcProvider = (SCErisWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCErisSkyProvider.sunTexture);
