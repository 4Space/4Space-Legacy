...
import mattparks.mods.starcraft.pluto.wgen.SCPlutoChunkProvider;
import mattparks.mods.starcraft.pluto.wgen.SCPlutoWorldChunkManager;
...
public class SCPlutoWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCPlutoChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCPlutoConfigManager.dimensionIDPluto;
    }
    ...
    {
        this.worldChunkMgr = new SCPlutoWorldChunkManager();
    }
