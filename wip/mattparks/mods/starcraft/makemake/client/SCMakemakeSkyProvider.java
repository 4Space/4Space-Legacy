package mattparks.mods.starcraft.makemake.client;
...
public class SCMakemakeSkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(MakemakeCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCMakemakeSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCMakemakeWorldProvider gcProvider = null;

        if (world.provider instanceof SCMakemakeWorldProvider)
        {
            gcProvider = (SCMakemakeWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCMakemakeSkyProvider.sunTexture);
