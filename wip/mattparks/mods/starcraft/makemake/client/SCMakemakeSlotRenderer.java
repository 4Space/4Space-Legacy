...
public class SCMakemakeSlotRenderer implements ICelestialBodyRenderer
{
    ...
    {
        return new ResourceLocation(MakemakeCore.ASSET_DOMAIN, "textures/gui/planets/makemake.png");
    }
