...
import mattparks.mods.starcraft.vesta.wgen.SCVestaChunkProvider;
import mattparks.mods.starcraft.vesta.wgen.SCVestaWorldChunkManager;
...
public class SCVestaWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCVestaChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCVestaConfigManager.dimensionIDVesta;
    }
    ...
    {
        this.worldChunkMgr = new SCVestaWorldChunkManager();
    }
