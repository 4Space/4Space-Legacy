...
public class SCPlutoRoomEmpty extends GCCoreDungeonRoom
{
    ...
    public SCPlutoRoomEmpty(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new SCPlutoRoomEmpty(dungeon, x, y, z, dir);
    }
