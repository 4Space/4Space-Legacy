...
import mattparks.mods.starcraft.mercury.wgen.SCMercuryChunkProvider;
import mattparks.mods.starcraft.mercury.wgen.SCMercuryWorldChunkManager;
...
public class SCMercuryWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCMercuryChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCMercuryConfigManager.dimensionIDMercury;
    }
    ...
    {
        this.worldChunkMgr = new SCMercuryWorldChunkManager();
    }
