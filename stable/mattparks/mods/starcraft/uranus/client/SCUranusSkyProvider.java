...
public class SCUranusSkyProvider extends IRenderHandler
{
    private static final ResourceLocation neptuneTexture = new ResourceLocation(UranusCore.ASSET_DOMAIN, "textures/gui/planets/neptune.png");
    private static final ResourceLocation sunTexture = new ResourceLocation(UranusCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCUranusSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCUranusWorldProvider gcProvider = null;

        if (world.provider instanceof SCUranusWorldProvider)
        {
            gcProvider = (SCUranusWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCUranusSkyProvider.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCUranusSkyProvider.neptuneTexture);
        var23.startDrawingQuads();
