...
{
    final short topBlockID = (short) Block.bedrock.blockID;
    final byte topBlockMeta = 2;
    final short fillBlockID = (short) Block.bedrock.blockID;
    ...
    {
        return SCGanymedeConfigManager.generateOtherMods ? "RandomLevelSource" : "IoLevelSource";
    }
