package mattparks.mods.starcraft.io.dimension;

import mattparks.mods.starcraft.io.SCIoConfigManager;
import mattparks.mods.starcraft.io.wgen.SCIoChunkProvider;
import mattparks.mods.starcraft.io.wgen.SCIoWorldChunkManager;
...
public class SCIoWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCIoChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCIoConfigManager.dimensionIDIo;
    }
    ...
    {
        this.worldChunkMgr = new SCIoWorldChunkManager();
    }
