...
import mattparks.mods.starcraft.jupiter.wgen.SCJupiterChunkProvider;
import mattparks.mods.starcraft.jupiter.wgen.SCJupiterWorldChunkManager;
...
public class SCJupiterWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCJupiterChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCJupiterConfigManager.dimensionIDJupiter;
    }
    ...
    {
        this.worldChunkMgr = new SCJupiterWorldChunkManager();
    }
