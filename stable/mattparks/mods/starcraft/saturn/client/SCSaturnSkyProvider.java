...
public class SCSaturnSkyProvider extends IRenderHandler
{
    private static final ResourceLocation uranusTexture = new ResourceLocation(SaturnCore.ASSET_DOMAIN, "textures/gui/planets/uranus.png");
    private static final ResourceLocation sunTexture = new ResourceLocation(SaturnCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCSaturnSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCSaturnWorldProvider gcProvider = null;

        if (world.provider instanceof SCSaturnWorldProvider)
        {
            gcProvider = (SCSaturnWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCSaturnSkyProvider.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCSaturnSkyProvider.uranusTexture);
        var23.startDrawingQuads();
