...
public class SCMercuryRoomBoss extends GCCoreDungeonRoom
{
    ...
    public SCMercuryRoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
...
//            GCCoreTileEntityDungeonSpawner spawner = new GCMarsTileEntityDungeonSpawner();
    ...
    {
        return new SCMercuryRoomBoss(dungeon, x, y, z, dir);
    }
