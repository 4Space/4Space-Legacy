...
public class SCVenusComponentVillageTorch extends SCVenusComponentVillage
{
    @SuppressWarnings("rawtypes")
    public static StructureBoundingBox func_74904_a(SCVenusComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
    ...
    public SCVenusComponentVillageTorch()
    {
    }

    public SCVenusComponentVillageTorch(SCVenusComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
