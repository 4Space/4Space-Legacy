...
public class SCVenusComponentBlazePitRoom extends GCCoreStructureComponent
{
    ...
    public SCVenusComponentBlazePitRoom(int type, World world, Random par2Random, int x, int y, int z, int height, int width, int cbm)
    {
        super(type);
