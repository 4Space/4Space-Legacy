...
public class SCVenusGuiSchematicRocketT3 extends GuiContainer implements ISchematicResultPage
{
    private static final ResourceLocation tier3SchematicTexture = new ResourceLocation(VenusCore.ASSET_DOMAIN, "textures/gui/schematic_rocket_T3.png");

    private int pageIndex;

    public SCVenusGuiSchematicRocketT3(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new SCVenusContainerRocketBenchT3(par1InventoryPlayer, x, y, z));
        this.ySize = 238;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(SCVenusGuiSchematicRocketT3.tier3SchematicTexture);
