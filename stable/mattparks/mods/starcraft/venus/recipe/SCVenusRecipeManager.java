...
public class SCVenusRecipeManager
{
    private static void addUniversalRecipes()
    {
    	...
    	OreDictionary.registerOre("vurnBerry", new ItemStack(VenusItems.vurnBerry, 1, 12));
    	OreDictionary.registerOre("meteoricIronIngot", new ItemStack(GCCoreItems.meteoricIronIngot));
    	OreDictionary.registerOre("venusMeteorBlock", new ItemStack(VenusBlocks.VenusMeteorBlock));
        ...
        RecipeUtil.addRecipe(new ItemStack(GCCoreItems.meteoricIronIngot, 9, 1), new Object[] { "   ", " X ", "   ", 'X', "venusMeteorBlock" });
        
        RecipeUtil.addRecipe(new ItemStack(VenusItems.venusItemBasic, 9, 11), new Object[] { "   ", " X ", "   ", 'X', "CrystalBlock" });
