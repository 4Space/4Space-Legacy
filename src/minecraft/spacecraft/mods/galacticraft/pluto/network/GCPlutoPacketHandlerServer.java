package spacecraft.mods.galacticraft.pluto.network;
...
public class GCPlutoPacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Galacticraft Pluto: Received bad packet!");
        }
