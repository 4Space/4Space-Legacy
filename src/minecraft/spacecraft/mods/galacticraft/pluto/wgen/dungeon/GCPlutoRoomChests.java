...
public class GCPlutoRoomChests extends GCCoreDungeonRoom
{
    ...
    public GCPlutoRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
