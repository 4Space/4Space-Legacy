package spacecraft.mods.galacticraft.pluto.wgen.dungeon;
...
public class GCPlutoRoomTreasure extends GCCoreDungeonRoom
{
    ...
    public GCPlutoRoomTreasure(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCPlutoRoomTreasure(dungeon, x, y, z, dir);
    }
