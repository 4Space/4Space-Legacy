...
public class GCMercuryComponentVillageField2 extends GCMercuryComponentVillage
{
    ...
    public GCMercuryComponentVillageField2()
    {
    }

    public GCMercuryComponentVillageField2(GCMercuryComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static GCMercuryComponentVillageField2 func_74900_a(GCMercuryComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return GCMercuryComponentVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new GCMercuryComponentVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
