...
public class GCMercuryRoomChests extends GCCoreDungeonRoom
{
    ...
    public GCMercuryRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCMercuryRoomChests(dungeon, x, y, z, dir);
    }
