package spacecraft.mods.galacticraft.mercury.wgen.dungeon;
...
public class GCMercuryRoomTreasure extends GCCoreDungeonRoom
{
    ...
    public GCMercuryRoomTreasure(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCMercuryRoomTreasure(dungeon, x, y, z, dir);
    }
