...
public class GCMercuryRoomEmpty extends GCCoreDungeonRoom
{
    ...
    public GCMercuryRoomEmpty(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
