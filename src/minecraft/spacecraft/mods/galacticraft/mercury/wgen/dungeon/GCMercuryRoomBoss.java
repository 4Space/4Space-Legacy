...
public class GCMercuryRoomBoss extends GCCoreDungeonRoom
{
    ...
    public GCMercuryRoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
