package spacecraft.mods.galacticraft.mercury.wgen;
...
public abstract class GCMercuryComponent extends StructureComponent
{
    public GCMercuryComponent(int var1)
    {
        super(var1);
    }
