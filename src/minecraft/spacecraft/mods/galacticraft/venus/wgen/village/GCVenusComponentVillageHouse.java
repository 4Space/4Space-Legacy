...
public class GCVenusComponentVillageHouse extends GCVenusComponentVillage
{
    private int averageGroundLevel = -1;

    public GCVenusComponentVillageHouse()
    {
    }

    public GCVenusComponentVillageHouse(GCVenusComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static GCVenusComponentVillageHouse func_74921_a(GCVenusComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        final StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 17, 9, 17, par6);
        return StructureComponent.findIntersecting(par1List, var8) == null ? new GCVenusComponentVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
