...
public class GCVenusComponentVillageWell extends GCVenusComponentVillage
{
    private int averageGroundLevel = -1;

    public GCVenusComponentVillageWell()
    {
    }

    public GCVenusComponentVillageWell(GCVenusComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5)
    {
