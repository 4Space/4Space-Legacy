...
public class GCVenusEntityVenusianVillager extends EntityAgeable implements IEntityBreathable
{
    ...
    public GCVenusEntityVenusianVillager(World par1World)
    {
        super(par1World);
    ...
    public GCVenusEntityVenusianVillager func_90012_b(EntityAgeable par1EntityAgeable)
    {
        final GCVenusEntityVenusianVillager entityvillager = new GCVenusEntityVenusianVillager(this.worldObj);
