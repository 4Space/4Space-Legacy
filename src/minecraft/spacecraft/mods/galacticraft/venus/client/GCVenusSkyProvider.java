...
public class GCVenusSkyProvider extends IRenderHandler
{
    ...
    {
        GCVenusWorldProvider gcProvider = null;

        if (world.provider instanceof GCVenusWorldProvider)
        {
            gcProvider = (GCVenusWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCVenusSkyProvider.sunTexture);
        var23.startDrawingQuads();
