package spacecraft.mods.galacticraft.uranus;

import java.io.File;
import java.util.HashMap;

import spacecraft.mods.galacticraft.uranus.dimension.GCUranusTeleportType;
import spacecraft.mods.galacticraft.uranus.dimension.GCUranusWorldProvider;
import spacecraft.mods.galacticraft.uranus.network.GCUranusPacketHandlerServer;
...
public class GCUranus
{
    ...
    @SidedProxy(clientSide = "spacecraft.mods.galacticraft.uranus.client.ClientProxyUranus", serverSide = "spacecraft.mods.galacticraft.uranus.CommonProxyUranus")
