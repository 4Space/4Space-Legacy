package spacecraft.mods.galacticraft.core.entities;
...
public class SCCoreEntityRocketT3 extends EntityTieredRocket
{
    public IUpdatePlayerListBox rocketSoundUpdater;

    public SCCoreEntityRocketT3(World par1World)
    {
        super(par1World);
    }

    public SCCoreEntityRocketT3(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
    ...
    public SCCoreEntityRocketT3(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
