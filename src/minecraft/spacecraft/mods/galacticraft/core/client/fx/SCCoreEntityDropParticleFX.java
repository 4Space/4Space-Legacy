package spacecraft.mods.galacticraft.core.client.fx;
...
public class SCCoreEntityDropParticleFX extends EntityFX
{
    ...
    public SCCoreEntityDropParticleFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
