package spacecraft.mods.galacticraft.core.client.render.item;
...
public class SCCoreItemRendererSpaceshipT3 extends GCCoreItemRendererSpaceship
{
    private static final ResourceLocation cargoRocketTexture = new ResourceLocation(SpacecraftCore.TEXTURE_DOMAIN, "textures/model/cargoRocket.png");
    private IModelCustom cargoRocketModel;

    public SCCoreItemRendererSpaceshipT3(IModelCustom cargoRocketModel)
    {
        super(new SCCoreEntityRocketT3(FMLClientHandler.instance().getClient().theWorld), new SCCoreModelSpaceshipTier3(), new ResourceLocation(SpacecraftCore.TEXTURE_DOMAIN, "textures/model/rocketT3.png"));
    ...
    protected void renderSpaceship(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        ...
        {
            FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCCoreItemRendererSpaceshipT3.cargoRocketTexture);
