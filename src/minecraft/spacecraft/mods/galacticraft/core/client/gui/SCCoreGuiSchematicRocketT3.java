package spacecraft.mods.galacticraft.core.client.gui;
...
{
    private static final ResourceLocation tier3SchematicTexture = new ResourceLocation(SpacecraftCore.TEXTURE_DOMAIN, "textures/gui/schematic_rocket_T3.png");

    private int pageIndex;

    public SCCoreGuiSchematicRocketT3(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(SCCoreGuiSchematicRocketT3.tier3SchematicTexture);
