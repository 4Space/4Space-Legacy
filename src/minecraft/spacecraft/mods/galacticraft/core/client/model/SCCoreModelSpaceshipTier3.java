package spacecraft.mods.galacticraft.core.client.model;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class SCCoreModelSpaceshipTier3 extends ModelBase
{
    // Roof, Floor, Bottom
    ...
    public SCCoreModelSpaceshipTier3()
    {
        this(0.0F);
    }

    public SCCoreModelSpaceshipTier3(float var1)
    {
