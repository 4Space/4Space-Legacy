package spacecraft.mods.galacticraft.core.inventory;

import spacecraft.mods.galacticraft.core.util.RecipeUtilSCCore;
...
public class SCCoreContainerRocketBenchT3 extends Container
{
    public SCCoreInventoryRocketBenchT3 craftMatrix = new SCCoreInventoryRocketBenchT3(this);
    public IInventory craftResult = new InventoryCraftResult();
    private final World worldObj;

    public SCCoreContainerRocketBenchT3(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
