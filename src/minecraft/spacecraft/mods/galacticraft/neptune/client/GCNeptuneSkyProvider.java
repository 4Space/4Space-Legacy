package spacecraft.mods.galacticraft.neptune.client;
...
import spacecraft.mods.galacticraft.neptune.GCNeptune;
import spacecraft.mods.galacticraft.neptune.dimension.GCNeptuneWorldProvider;
import cpw.mods.fml.client.FMLClientHandler;

public class GCNeptuneSkyProvider extends IRenderHandler
{
    ...
    private static final ResourceLocation sunTexture = new ResourceLocation(GCNeptune.TEXTURE_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public GCNeptuneSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        GCNeptuneWorldProvider gcProvider = null;

        if (world.provider instanceof GCNeptuneWorldProvider)
        {
            gcProvider = (GCNeptuneWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCNeptuneSkyProvider.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCNeptuneSkyProvider.overworldTexture);
        var23.startDrawingQuads();
