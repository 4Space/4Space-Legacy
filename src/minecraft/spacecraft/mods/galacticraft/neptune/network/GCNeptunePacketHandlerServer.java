package spacecraft.mods.galacticraft.neptune.network;
...
public class GCNeptunePacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Galacticraft Neptune: Received bad packet!");
        }
