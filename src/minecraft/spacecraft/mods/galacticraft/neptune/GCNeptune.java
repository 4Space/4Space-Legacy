package spacecraft.mods.galacticraft.neptune;

import java.io.File;
import java.util.HashMap;

import spacecraft.mods.galacticraft.neptune.dimension.GCNeptuneTeleportType;
import spacecraft.mods.galacticraft.neptune.dimension.GCNeptuneWorldProvider;
import spacecraft.mods.galacticraft.neptune.network.GCNeptunePacketHandlerServer;
...
public class GCNeptune
{
    ...
    @SidedProxy(clientSide = "spacecraft.mods.galacticraft.neptune.client.ClientProxyNeptune", serverSide = "spacecraft.mods.galacticraft.neptune.CommonProxyNeptune")
