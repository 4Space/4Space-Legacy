...
{
    public static String[] names = { "ingotGem", "itemGem", "redGemPlate", "pressureRegulator", "heatRegulator", "jetpackFuel", "oxygenTubeFull", "oxygenTubeEmpty", "oxygenTubeUnlimited", "gravityGeneratorCore" };
