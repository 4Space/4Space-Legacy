...
//                    StarcraftLog.info("Found matching world name for " + (String) packetReadout[0]);
...
//                    player.playerNetServerHandler.sendPacketToPlayer(PacketUtil.createPacket(GalacticraftCore.CHANNEL, EnumPacketClient.CLOSE_GUI, toSend));
                ...
                {
//                    StarcraftLog.severe("Error occurred when attempting to transfer entity to dimension: " + (String) packetReadout[0]);
                    e.printStackTrace();
                }
            }
//            break;
