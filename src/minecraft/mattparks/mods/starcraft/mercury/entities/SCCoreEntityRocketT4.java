...
public class SCCoreEntityRocketT4 extends EntityTieredRocket
{
    public IUpdatePlayerListBox rocketSoundUpdater;

    public SCCoreEntityRocketT4(World par1World)
    {
        super(par1World);
    }

    public SCCoreEntityRocketT4(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
    ...
    public SCCoreEntityRocketT4(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
