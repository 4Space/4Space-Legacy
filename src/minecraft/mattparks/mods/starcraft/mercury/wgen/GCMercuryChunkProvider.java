...
import mattparks.mods.starcraft.mercury.wgen.dungeon.GCMercuryRoomEmpty;
import mattparks.mods.starcraft.mercury.wgen.dungeon.GCMercuryRoomSpawner;
import mattparks.mods.starcraft.mercury.wgen.dungeon.GCMercuryRoomTreasure;
import mattparks.mods.starcraft.mercury.wgen.village.GCMercuryMapGenVillage;
...
{
    final short topBlockID = (short) StarcraftMercury.MercuryGrass.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftMercury.MercuryDirt.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftMercury.MercuryStone.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftMercury.MercuryBrick.blockID, 14, 8, 16, 3);
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         GCMercuryConfigManager.generateOtherMods)
         {
