package mattparks.mods.starcraft.mercury.wgen.dungeon;
...
public class SCMercuryRoomSpawner extends GCCoreDungeonRoom
{
    ...
    public SCMercuryRoomSpawner(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    protected void handleTileEntities(Random rand)
    {
        for (final ChunkCoordinates spawnerCoords : this.spawners)
        {
            ...
            if (spawner != null)
            {
                spawner.getSpawnerLogic().setMobID(SCMercuryRoomSpawner.getMob(rand));
            }
        }
    }
    ...
    {
        return new SCMercuryRoomSpawner(dungeon, x, y, z, dir);
    }
}
