...
public class SCMercuryRoomTreasure extends GCCoreDungeonRoom
{
    ...
    public SCMercuryRoomTreasure(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new SCMercuryRoomTreasure(dungeon, x, y, z, dir);
    }
}
