...
public class SCMercuryRoomEmpty extends GCCoreDungeonRoom
{
    ...
    public SCMercuryRoomEmpty(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new SCMercuryRoomEmpty(dungeon, x, y, z, dir);
    }
