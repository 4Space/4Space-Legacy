...
public class SCMercurySlotRenderer implements ICelestialBodyRenderer
{
    ...
    {
        return new ResourceLocation(MercuryCore.ASSET_DOMAIN, "textures/gui/planets/mercury.png");
    }
