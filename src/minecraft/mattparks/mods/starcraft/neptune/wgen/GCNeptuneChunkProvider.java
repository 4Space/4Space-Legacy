...
{
    final short topBlockID = (short) StarcraftBlocks.NeptuneNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftBlocks.NeptuneHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftBlocks.NeptuneHydrogen.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftBlocks.JupiterHydrogen.blockID, 14, 8, 16, 3);
