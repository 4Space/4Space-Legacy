...
public class GCNeptuneChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) StarcraftGasPlanets.NeptuneNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftGasPlanets.NeptuneHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftGasPlanets.NeptuneHydrogen.blockID;
    ...
    public GCNeptuneBiomeDecorator biomedecoratorplanet = new GCNeptuneBiomeDecorator(GCNeptuneBiomeGenBase.venusFlat);

    private final World worldObj;
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftGasPlanets.JupiterHydrogen.blockID, 14, 8, 16, 3);
    //Need to make Jupiter Brick
    {
    }

    private BiomeGenBase[] biomesForGeneration = { GCNeptuneBiomeGenBase.venusFlat };
    ...
    public GCNeptuneChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < GCNeptuneChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < GCNeptuneChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < GCNeptuneChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < GCNeptuneChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         GCNeptuneConfigManager.generateOtherMods)
         {
    ...
    {
        return GCNeptuneConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
