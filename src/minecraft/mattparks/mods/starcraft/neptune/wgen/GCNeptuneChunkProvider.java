...
{
    final short topBlockID = (short) StarcraftGas.NeptuneNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftGas.NeptuneHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftGas.NeptuneHydrogen.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftGas.JupiterHydrogen.blockID, 14, 8, 16, 3);
