...
import mattparks.mods.starcraft.core.StarcraftCore; // Just for creative tabs
import mattparks.mods.starcraft.spacecraftBlocks.network.SCCorePacketHandlerServer;
import mattparks.mods.starcraft.mercury.GCMercury;
import mattparks.mods.starcraft.spacecraftBlocks.blocks.*;
...
@Mod(name = SpacecraftBlocks.NAME, version = GalacticraftCore.LOCALMAJVERSION + "." + GalacticraftCore.LOCALMINVERSION + "." + GalacticraftCore.LOCALBUILDVERSION, useMetadata = true, modid = SpacecraftBlocks.MODID, dependencies = "required-after:" + GalacticraftCore.MODID + ";")
@NetworkMod(channels = { SpacecraftBlocks.CHANNEL }, clientSideRequired = true, serverSideRequired = false, connectionHandler = GCCoreConnectionHandler.class, packetHandler = GCCorePacketManager.class)
public class SpacecraftBlocks
{
    public static final String NAME = "Starcraft Core 2";
    public static final String MODID = "StarcraftCore2";
    public static final String CHANNEL = "GCStarcraftCore2";
    public static final String CHANNELENTITIES = "SCCore2Entities";
...
//    public static long slowTick;
    ...
    {
        new SpacecraftBlocksConfigManager(new File(event.getModConfigurationDirectory(), "starcraft/core2.conf"));

        SpacecraftBlocks.proxy.preInit(event);
    }
...
//        }
//
//        GCLog.info("Starcraft Core 2 Loaded: " + languages + " Languages.");

//        SchematicRegistry.registerSchematicRecipe(new GCVenusSchematicRocketT3());
        // TODO add Tier 3-6 to crafting bench  
        
        NetworkRegistry.instance().registerGuiHandler(SpacecraftBlocks.instance, SpacecraftBlocks.proxy);
        this.registerTileEntities();
        this.registerCreatures();
        this.registerOtherEntities();
        SpacecraftBlocks.proxy.init(event);
//        GalacticraftRegistry.addDungeonLoot(2, new ItemStack(SCCoreItems.schematic, 1, 0));
    ...
    {
        NetworkRegistry.instance().registerChannel(new SCCorePacketHandlerServer(), SpacecraftBlocks.CHANNEL, Side.SERVER);
    }
    ...
    {
        SpacecraftBlocks.proxy.postInit(event);
        SpacecraftBlocks.proxy.registerRenderInformation();
    }

    public void registerGalacticraftCreature(Class<? extends Entity> var0, String var1, int id, int back, int fore)
    {
        EntityRegistry.registerGlobalEntityID(var0, var1, id, back, fore);
        EntityRegistry.registerModEntity(var0, var1, id, SpacecraftBlocks.instance, 80, 3, true);
    }
