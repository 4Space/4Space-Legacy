package mattparks.mods.starcraft.spacecraftBlocks.network;
...
public class SCCorePacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Starcraft Core 2: Received bad packet!");
        }
