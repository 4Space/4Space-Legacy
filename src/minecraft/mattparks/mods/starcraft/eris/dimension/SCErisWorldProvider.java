...
import mattparks.mods.starcraft.eris.wgen.SCErisChunkProvider;
import mattparks.mods.starcraft.eris.wgen.SCErisWorldChunkManager;
...
public class SCErisWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    ...
    {
        return new SCErisChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCErisConfigManager.dimensionIDEris;
    }
    ...
    {
        this.worldChunkMgr = new SCErisWorldChunkManager();
    }
