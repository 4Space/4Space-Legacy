...
public class GCErisWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return "DIM" + GCErisConfigManager.dimensionIDEris;
    }
