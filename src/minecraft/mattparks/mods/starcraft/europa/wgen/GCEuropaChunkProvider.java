...
public class GCEuropaChunkProvider extends ChunkProviderGenerate
{
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < GCEuropaChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < GCEuropaChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < GCEuropaChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < GCEuropaChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return GCEuropaConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         GCEuropaConfigManager.generateOtherMods)
         {
