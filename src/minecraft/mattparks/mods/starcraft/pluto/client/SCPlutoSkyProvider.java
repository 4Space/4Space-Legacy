...
public class SCPlutoSkyProvider extends IRenderHandler
{
    private static final ResourceLocation erisTexture = new ResourceLocation(PlutoCore.ASSET_DOMAIN, "textures/gui/planets/eris.png");
    private static final ResourceLocation charonTexture = new ResourceLocation(PlutoCore.ASSET_DOMAIN, "textures/gui/planets/charon.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCPlutoSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCPlutoWorldProvider gcProvider = null;

        if (world.provider instanceof SCPlutoWorldProvider)
        {
            gcProvider = (SCPlutoWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCPlutoSkyProvider.charonTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCPlutoSkyProvider.erisTexture);
        var23.startDrawingQuads();
