...
public class SCPlutoRoomBoss extends GCCoreDungeonRoom
{
    ...
    public SCPlutoRoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
...
//            GCCoreTileEntityDungeonSpawner spawner = new GCMarsTileEntityDungeonSpawner();
    ...
    {
        return new SCPlutoRoomBoss(dungeon, x, y, z, dir);
    }
