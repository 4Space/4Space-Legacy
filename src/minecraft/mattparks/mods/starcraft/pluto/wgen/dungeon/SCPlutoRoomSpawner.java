...
public class SCPlutoRoomSpawner extends GCCoreDungeonRoom
{
    ...
    public SCPlutoRoomSpawner(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    protected void handleTileEntities(Random rand)
    {
        for (final ChunkCoordinates spawnerCoords : this.spawners)
        {
            ...
            if (spawner != null)
            {
                spawner.getSpawnerLogic().setMobID(SCPlutoRoomSpawner.getMob(rand));
            }
        }
    }
    ...
    {
        return new SCPlutoRoomSpawner(dungeon, x, y, z, dir);
    }
}
