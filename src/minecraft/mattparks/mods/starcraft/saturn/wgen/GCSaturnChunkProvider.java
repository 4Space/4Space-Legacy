...
{
    final short topBlockID = (short) StarcraftBlocks.SaturnNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftBlocks.SaturnHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftBlocks.SaturnHydrogen.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftBlocks.SaturnHydrogen.blockID, 14, 8, 16, 3);
