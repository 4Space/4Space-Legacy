...
{
    final short topBlockID = (short) StarcraftCore.SaturnNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftCore.SaturnHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftCore.SaturnHydrogen.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftCore.SaturnHydrogen.blockID, 14, 8, 16, 3);
