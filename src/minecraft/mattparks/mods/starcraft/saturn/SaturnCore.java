...
import mattparks.mods.starcraft.saturn.dimension.SCSaturnTeleportType;
import mattparks.mods.starcraft.saturn.dimension.SCSaturnWorldProvider;
import mattparks.mods.starcraft.saturn.network.SCSaturnPacketHandlerServer;
...
public class SaturnCore
{
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        GalacticraftRegistry.registerTeleportType(SCSaturnWorldProvider.class, new SCSaturnTeleportType());
        GalacticraftRegistry.registerCelestialBody(new SCSaturnPlanet());
        GalacticraftRegistry.registerRocketGui(SCSaturnWorldProvider.class, new ResourceLocation(SaturnCore.ASSET_DOMAIN, "textures/gui/saturnRocketGui.png"));
    }
    ...
    {
        new SCSaturnConfigManager(new File(event.getModConfigurationDirectory(), "starcraft/saturn.conf"));
    ...
    {
        NetworkRegistry.instance().registerChannel(new SCSaturnPacketHandlerServer(), SaturnCore.CHANNEL, Side.SERVER);
    }
}
