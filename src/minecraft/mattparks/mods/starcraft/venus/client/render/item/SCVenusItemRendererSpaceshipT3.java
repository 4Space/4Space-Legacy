...
public class SCVenusItemRendererSpaceshipT3 extends GCCoreItemRendererSpaceship
{
    ...
    public SCVenusItemRendererSpaceshipT3(IModelCustom cargoRocketModel)
    {
        super(new SCVenusEntityRocketT3(FMLClientHandler.instance().getClient().theWorld), new SCCoreModelSpaceshipTier3(), new ResourceLocation(VenusCore.ASSET_DOMAIN, "textures/model/rocketT3.png"));
