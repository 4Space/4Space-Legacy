...
public class SCVenusStructureVillageStart extends StructureStart
{
    public SCVenusStructureVillageStart()
    {
    }

    @SuppressWarnings("unchecked")
    public SCVenusStructureVillageStart(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        try
        {
        ...
        final ArrayList<SCVenusStructureVillagePieceWeight> var6 = SCVenusStructureVillagePieces.getStructureVillageWeightedPieceList(par2Random, par5);
        final SCVenusComponentVillageStartPiece var7 = new SCVenusComponentVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
        ...
        while (var13.hasNext())
        {
            ...
            if (!(var12 instanceof SCVenusComponentVillageRoadPiece))
            {
                ++var10;
            }
        }
