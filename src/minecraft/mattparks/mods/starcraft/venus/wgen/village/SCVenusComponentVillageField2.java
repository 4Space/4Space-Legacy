...
public class SCVenusComponentVillageField2 extends SCVenusComponentVillage
{
    @SuppressWarnings("rawtypes")
    public static SCVenusComponentVillageField2 func_74900_a(SCVenusComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return SCVenusComponentVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new SCVenusComponentVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
    ...
    public SCVenusComponentVillageField2()
    {
    }

    public SCVenusComponentVillageField2(SCVenusComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
