...
{
    final short topBlockID = (short) StarcraftCore.VenusGrass.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftCore.VenusDirt.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftCore.VenusStone.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftCore.VenusBrick.blockID, 14, 8, 16, 3);
