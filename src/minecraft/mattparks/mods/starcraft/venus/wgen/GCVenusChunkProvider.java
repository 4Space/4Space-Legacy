...
import mattparks.mods.starcraft.venus.wgen.dungeon.GCVenusRoomSpawner;
import mattparks.mods.starcraft.venus.wgen.dungeon.GCVenusRoomTreasure;
import mattparks.mods.starcraft.venus.wgen.village.GCVenusMapGenVillage;
...
{
    final short topBlockID = (short) SpacecraftBlocks.VenusGrass.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) SpacecraftBlocks.VenusDirt.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) SpacecraftBlocks.VenusStone.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(SpacecraftBlocks.VenusBrick.blockID, 14, 8, 16, 3);
    ...
    private final GCCoreMapGenBaseMeta caveGenerator = new GCVenusGenCaves();
