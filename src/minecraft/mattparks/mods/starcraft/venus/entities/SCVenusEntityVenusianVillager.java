...
public class SCVenusEntityVenusianVillager extends EntityAgeable implements IEntityBreathable
{
    ...
    public SCVenusEntityVenusianVillager(World par1World)
    {
        super(par1World);
    ...
    public SCVenusEntityVenusianVillager func_90012_b(EntityAgeable par1EntityAgeable)
    {
        final SCVenusEntityVenusianVillager entityvillager = new SCVenusEntityVenusianVillager(this.worldObj);
