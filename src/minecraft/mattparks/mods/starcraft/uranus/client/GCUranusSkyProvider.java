...
public class GCUranusSkyProvider extends IRenderHandler
{
    ...
    {
        GCUranusWorldProvider gcProvider = null;

        if (world.provider instanceof GCUranusWorldProvider)
        {
            gcProvider = (GCUranusWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCUranusSkyProvider.sunTexture);
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCUranusSkyProvider.overworldTexture);
        var23.startDrawingQuads();
