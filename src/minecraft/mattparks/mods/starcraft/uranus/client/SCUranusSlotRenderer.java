...
public class SCUranusSlotRenderer implements ICelestialBodyRenderer
{
    ...
    {
        return new ResourceLocation(UranusCore.ASSET_DOMAIN, "textures/gui/planets/uranus.png");
    }
