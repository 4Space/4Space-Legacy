...
{
    final short topBlockID = (short) StarcraftGas.UranusNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftGas.UranusHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftGas.UranusHydrogen.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(StarcraftGas.UranusHydrogen.blockID, 14, 8, 16, 3);
