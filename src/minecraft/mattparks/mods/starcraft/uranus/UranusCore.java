...
import mattparks.mods.starcraft.uranus.dimension.SCUranusTeleportType;
import mattparks.mods.starcraft.uranus.dimension.SCUranusWorldProvider;
import mattparks.mods.starcraft.uranus.network.SCUranusPacketHandlerServer;
...
public class UranusCore
{
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        GalacticraftRegistry.registerTeleportType(SCUranusWorldProvider.class, new SCUranusTeleportType());
        GalacticraftRegistry.registerCelestialBody(new SCUranusPlanet());
        GalacticraftRegistry.registerRocketGui(SCUranusWorldProvider.class, new ResourceLocation(UranusCore.ASSET_DOMAIN, "textures/gui/saturnRocketGui.png"));
    }
    ...
    {
        new SCUranusConfigManager(new File(event.getModConfigurationDirectory(), "starcraft/uranus.conf"));
    ...
    {
        NetworkRegistry.instance().registerChannel(new SCUranusPacketHandlerServer(), UranusCore.CHANNEL, Side.SERVER);
    }
}
