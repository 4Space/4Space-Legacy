...
import mattparks.mods.starcraft.uranus.wgen.SCUranusChunkProvider;
import mattparks.mods.starcraft.uranus.wgen.SCUranusWorldChunkManager;
...
public class SCUranusWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
...
// This code changes the sky color and adds a fog to it. Change the 0s in the .getVecFromPool to an RGB code. I find darker colors work better
    ...
    {
        return new SCUranusChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCUranusConfigManager.dimensionIDUranus;
    }
    ...
    {
        this.worldChunkMgr = new SCUranusWorldChunkManager();
    }
