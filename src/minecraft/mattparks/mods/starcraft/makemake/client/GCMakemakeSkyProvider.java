...
public class GCMakemakeSkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(GCMakemake.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public GCMakemakeSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        GCMakemakeWorldProvider gcProvider = null;

        if (world.provider instanceof GCMakemakeWorldProvider)
        {
            gcProvider = (GCMakemakeWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCMakemakeSkyProvider.sunTexture);
