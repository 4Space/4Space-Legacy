package mattparks.mods.starcraft.makemake.network;
...
public class GCMakemakePacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Starcraft Makemake: Received bad packet!");
        }
