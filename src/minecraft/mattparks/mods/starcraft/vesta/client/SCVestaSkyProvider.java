...
public class SCVestaSkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(VestaCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCVestaSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCVestaWorldProvider gcProvider = null;

        if (world.provider instanceof SCVestaWorldProvider)
        {
            gcProvider = (SCVestaWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCVestaSkyProvider.sunTexture);
