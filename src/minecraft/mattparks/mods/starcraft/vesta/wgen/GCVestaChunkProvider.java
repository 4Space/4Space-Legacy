...
public class GCVestaChunkProvider extends ChunkProviderGenerate
{
    ...
    public GCVestaChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < GCVestaChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < GCVestaChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < GCVestaChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < GCVestaChunkProvider.MID_HEIGHT + yDev)
                    {
