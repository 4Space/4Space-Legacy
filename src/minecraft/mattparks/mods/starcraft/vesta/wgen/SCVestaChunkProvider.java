...
public class SCVestaChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) VestaBlocks.VestaGrass.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) VestaBlocks.VestaDirt.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) VestaBlocks.VestaStone.blockID;
    ...
    public SCVestaBiomeDecorator biomedecoratorplanet = new SCVestaBiomeDecorator(SCVestaBiomeGenBase.vestaFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { SCVestaBiomeGenBase.vestaFlat };
    ...
    public SCVestaChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCVestaChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCVestaChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCVestaChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCVestaChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return SCVestaConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCVestaConfigManager.generateOtherMods)
         {
