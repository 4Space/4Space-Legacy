...
public class GCJupiterItem extends Item
{
    ...
    {
        for (int i = 0; i < GCJupiterItem.names.length; i++)
        {
    ...
    public String getUnlocalizedName(ItemStack par1ItemStack)
    {
        ...
        {
            return "item." + GCJupiterItem.names[par1ItemStack.getItemDamage()];
        }
    ...
    public void registerIcons(IconRegister iconRegister)
    {
        ...
        for (String name : GCJupiterItem.names)
        {
            this.icons[i++] = iconRegister.registerIcon(GCJupiter.ASSET_PREFIX + name);
        }
    }
}
