package mattparks.mods.starcraft.jupiter.entities;
...
public class SCJupiterEntityRocketT5 extends EntityTieredRocket
{
    public IUpdatePlayerListBox rocketSoundUpdater;

    public SCJupiterEntityRocketT5(World par1World)
    {
        super(par1World);
    }

    public SCJupiterEntityRocketT5(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
        this(par1World, par2, par4, par6, rocketType);
        this.cargoItems = inv;
    }

    public SCJupiterEntityRocketT5(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
