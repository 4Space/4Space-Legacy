...
public class SCJupiterItemRendererSpaceshipT5 extends GCCoreItemRendererSpaceship
{
    ...
    {
        super(new SCJupiterEntityRocketT5(FMLClientHandler.instance().getClient().theWorld), new SCJupiterModelSpaceshipTier5(), new ResourceLocation(JupiterCore.ASSET_DOMAIN, "textures/model/rocketT5.png"));
