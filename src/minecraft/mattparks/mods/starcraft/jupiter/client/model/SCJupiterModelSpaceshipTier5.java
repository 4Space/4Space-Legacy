package mattparks.mods.starcraft.jupiter.client.model;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class SCJupiterModelSpaceshipTier5 extends ModelBase
{
    // Roof, Floor, Bottom
    ...
    public SCJupiterModelSpaceshipTier5()
    {
        this(0.0F);
    }

    public SCJupiterModelSpaceshipTier5(float var1)
    {
