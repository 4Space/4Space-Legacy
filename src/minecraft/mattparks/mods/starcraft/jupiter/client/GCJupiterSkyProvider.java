...
{
    private static final ResourceLocation saturnTexture = new ResourceLocation(GCSaturn.ASSET_DOMAIN, "textures/gui/planets/saturn.png");
    private static final ResourceLocation sunTexture = new ResourceLocation(GCJupiter.ASSET_DOMAIN, "textures/gui/planets/sun.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCJupiterSkyProvider.saturnTexture);
        var23.startDrawingQuads();
