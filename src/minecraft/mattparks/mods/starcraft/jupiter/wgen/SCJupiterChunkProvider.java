...
public class SCJupiterChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) JupiterBlocks.JupiterNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) JupiterBlocks.JupiterHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) JupiterBlocks.JupiterHydrogen.blockID;
    ...
    public SCJupiterBiomeDecorator biomedecoratorplanet = new SCJupiterBiomeDecorator(SCJupiterBiomeGenBase.jupiterFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { SCJupiterBiomeGenBase.jupiterFlat };
    ...
    public SCJupiterChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCJupiterChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCJupiterChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCJupiterChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCJupiterChunkProvider.MID_HEIGHT + yDev)
                    {
    ...
    {
        return SCJupiterConfigManager.generateOtherMods ? "RandomLevelSource" : "VenusLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCJupiterConfigManager.generateOtherMods)
         {
