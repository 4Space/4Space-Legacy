...
{
    final short topBlockID = (short) StarcraftBlocks.JupiterNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) StarcraftBlocks.JupiterHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) StarcraftBlocks.JupiterHydrogen.blockID;
    ...
    public GCJupiterBiomeDecorator biomedecoratorplanet = new GCJupiterBiomeDecorator(GCJupiterBiomeGenBase.venusFlat);

    private final World worldObj;
    {
    }

    private BiomeGenBase[] biomesForGeneration = { GCJupiterBiomeGenBase.venusFlat };
    ...
    public GCJupiterChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < GCJupiterChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < GCJupiterChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < GCJupiterChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < GCJupiterChunkProvider.MID_HEIGHT + yDev)
                    {
