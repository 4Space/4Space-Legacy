...
public class SCJupiterConfigManager
{
    ...
    private void setDefaultValues()
    {
        try
        {
            ...
            SCJupiterConfigManager.dimensionIDJupiter = SCJupiterConfigManager.configuration.get("Dimensions", "Jupiter Dimension ID", -41).getInt(-41);
            ...
            SCJupiterConfigManager.idArmorClearDiamondHelmet = SCJupiterConfigManager.configuration.get(Configuration.CATEGORY_ITEM, "idArmorClearDiamondHelmet", 2852).getInt(2852);
