...
import mattparks.mods.starcraft.sedna.wgen.SCSednaChunkProvider;
import mattparks.mods.starcraft.sedna.wgen.SCSednaWorldChunkManager;
...
public class SCSednaWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return new SCSednaChunkProvider(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
    }
    ...
    {
        return "DIM" + SCSednaConfigManager.dimensionIDSedna;
    }
    ...
    {
        this.worldChunkMgr = new SCSednaWorldChunkManager();
    }
