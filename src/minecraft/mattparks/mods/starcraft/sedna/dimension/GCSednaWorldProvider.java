...
public class GCSednaWorldProvider extends WorldProvider implements IGalacticraftWorldProvider, ISolarLevel
{
    @Override
    ...
    {
        return "DIM" + GCSednaConfigManager.dimensionIDSedna;
    }
