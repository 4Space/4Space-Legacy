package mattparks.mods.starcraft.sedna.network;
...
public class GCSednaPacketHandlerServer implements IPacketHandler
{
    @Override
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player p)
    {
        ...
        {
            FMLLog.severe("Galacticraft Sedna: Received bad packet!");
        }
