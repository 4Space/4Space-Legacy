...
public class SCSednaRoomBoss extends GCCoreDungeonRoom
{
    ...
    public SCSednaRoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
...
//            GCCoreTileEntityDungeonSpawner spawner = new GCMarsTileEntityDungeonSpawner();
    ...
    {
        return new SCSednaRoomBoss(dungeon, x, y, z, dir);
    }
