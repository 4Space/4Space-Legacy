...
public class GCSednaRoomChests extends GCCoreDungeonRoom
{
    ...
    public GCSednaRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCSednaRoomChests(dungeon, x, y, z, dir);
    }
