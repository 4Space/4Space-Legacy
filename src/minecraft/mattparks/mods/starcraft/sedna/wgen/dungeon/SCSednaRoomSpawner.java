...
public class SCSednaRoomSpawner extends GCCoreDungeonRoom
{
    ...
    public SCSednaRoomSpawner(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    protected void handleTileEntities(Random rand)
    {
        for (final ChunkCoordinates spawnerCoords : this.spawners)
        {
            ...
            if (spawner != null)
            {
                spawner.getSpawnerLogic().setMobID(SCSednaRoomSpawner.getMob(rand));
            }
        }
    }
    ...
    {
        return new SCSednaRoomSpawner(dungeon, x, y, z, dir);
    }
}
