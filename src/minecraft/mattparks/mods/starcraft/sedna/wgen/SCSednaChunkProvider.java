...
import mattparks.mods.starcraft.sedna.blocks.SednaBlocks;
import mattparks.mods.starcraft.sedna.wgen.dungeon.SCSednaRoomBoss;
import mattparks.mods.starcraft.sedna.wgen.dungeon.SCSednaRoomChests;
import mattparks.mods.starcraft.sedna.wgen.dungeon.SCSednaRoomEmpty;
import mattparks.mods.starcraft.sedna.wgen.dungeon.SCSednaRoomSpawner;
import mattparks.mods.starcraft.sedna.wgen.dungeon.SCSednaRoomTreasure;
...
public class SCSednaChunkProvider extends ChunkProviderGenerate
{
    final short topBlockID = (short) SednaBlocks.SednaGrass.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) SednaBlocks.SednaDirt.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) SednaBlocks.SednaStone.blockID;
    ...
    public SCSednaBiomeDecorator biomedecoratorplanet = new SCSednaBiomeDecorator(SCSednaBiomeGenBase.sednaFlat);

    private final World worldObj;
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(SednaBlocks.SednaBrick.blockID, 14, 8, 16, 3);

    {
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomEmpty(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        ...
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomChests(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new SCSednaRoomChests(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.bossRooms.add(new SCSednaRoomBoss(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.treasureRooms.add(new SCSednaRoomTreasure(null, 0, 0, 0, ForgeDirection.UNKNOWN));
    }

    private BiomeGenBase[] biomesForGeneration = { SCSednaBiomeGenBase.sednaFlat };

    private final GCCoreMapGenBaseMeta caveGenerator = new SCSednaGenCaves();
    ...
    public SCSednaChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < SCSednaChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < SCSednaChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < SCSednaChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < SCSednaChunkProvider.MID_HEIGHT + yDev)
                    {
...
//            monsters.add(new SpawnListEntry(GCCoreEntityCreeper.class, 8, 2, 3));
    ...
    {
        return SCSednaConfigManager.generateOtherMods ? "RandomLevelSource" : "SednaLevelSource";
    }
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        final Chunk var4 = new Chunk(this.worldObj, ids, meta, par1, par2);
         ...
         SCSednaConfigManager.generateOtherMods)
         {
