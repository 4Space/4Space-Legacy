...
public class SCSednaSkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(SednaCore.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public SCSednaSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        SCSednaWorldProvider gcProvider = null;

        if (world.provider instanceof SCSednaWorldProvider)
        {
            gcProvider = (SCSednaWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SCSednaSkyProvider.sunTexture);
