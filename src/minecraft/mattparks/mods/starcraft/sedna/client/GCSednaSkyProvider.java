...
public class GCSednaSkyProvider extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(GCSedna.ASSET_DOMAIN, "textures/gui/planets/sun.png");

    public int starGLCallList = GLAllocation.generateDisplayLists(3);
    public int glSkyList;
    public int glSkyList2;

    public GCSednaSkyProvider()
    {
        GL11.glPushMatrix();
    ...
    {
        GCSednaWorldProvider gcProvider = null;

        if (world.provider instanceof GCSednaWorldProvider)
        {
            gcProvider = (GCSednaWorldProvider) world.provider;
        }
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCSednaSkyProvider.sunTexture);
