package mattparks.mods.starcraft.sedna.entities;
...
public class SCSednaEntityRocketT6 extends EntityTieredRocket
{
    public IUpdatePlayerListBox rocketSoundUpdater;

    public SCSednaEntityRocketT6(World par1World)
    {
        super(par1World);
    }

    public SCSednaEntityRocketT6(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
        this(par1World, par2, par4, par6, rocketType);
        this.cargoItems = inv;
    }

    public SCSednaEntityRocketT6(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
