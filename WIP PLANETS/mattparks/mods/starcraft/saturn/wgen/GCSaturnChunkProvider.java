...
{
    final short topBlockID = (short) SpacecraftBlocks.SaturnNitrogen.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) SpacecraftBlocks.SaturnHelium.blockID;
    final byte fillBlockMeta = 3;
    final short lowerBlockID = (short) SpacecraftBlocks.SaturnHydrogen.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(SpacecraftBlocks.SaturnHydrogen.blockID, 14, 8, 16, 3);
